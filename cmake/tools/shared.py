...
DEBUG = int(os.environ.get('NGAGESDK_DEBUG', '0'))
EMCC_LOGGING = int(os.environ.get('NGAGESDK_LOGGING', '1'))
...
DEBUG_SAVE = DEBUG or int(os.environ.get('NGAGESDK_DEBUG_SAVE', '0'))
PRINT_SUBPROCS = int(os.getenv('NGAGESDK_VERBOSE', '0'))
SKIP_SUBPROCS = False
